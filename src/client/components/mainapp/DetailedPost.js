...
class DetailedPost extends Component {
    ...
    render() {
        return <div className="DetailedPostBack">
            <div onClick={() => {
                this.props.unfocus()
            }} className="BlackScreen"></div>
            <div className="DetailedPost">
                <img id="image" src={"images/posts/" + this.props.post.image}/>
                <div className="DetailSecond">
                    <div className="PostHeader">
                        ...
                        <div ><img style={{width:"20px",height:"20px",padding:"8px",boxSizing:"padding-box"}} src={Dots}/></div>
                    </div>
                    <div className="CommentsSocial">
                        ...
                        <div className="SendComment">
                            <form onSubmit={this.onSubmit}>
                                <input onChange={(e)=>{this.setState({comment:e.target.value})}} value={this.state.comment} type="text" placeholder={"Добавьте комментарий..."}/>
